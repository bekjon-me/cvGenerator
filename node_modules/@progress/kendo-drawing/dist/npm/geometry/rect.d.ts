...
export class Rect {
     ...
     * @param cornerRadius - The corner radius of the rectangle as a single number or an `[rx, ry]` array.
     */
    constructor(origin: Point|number[], size: Size|number[], cornerRadius?: number | number[]);
     ...
     *
     * @param cornerRadius - The new corner radius of the rectangle as a single number or an `[rx, ry]` array.
     * @return - The current rectangle instance.
     */
    setCornerRadius(cornerRadius: number | number[]): Rect;
